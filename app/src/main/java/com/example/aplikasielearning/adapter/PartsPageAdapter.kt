...
import com.example.aplikasielearning.databinding.LayoutMarkdownBinding
import com.example.aplikasielearning.databinding.LayoutYoutubeBinding
import com.example.aplikasielearning.model.PartsPage
...
class PartsPageAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val partsPage = partsPage[position]
        when(getItemViewType(position)){
            TYPE_YOUTUBE -> (holder as YoutubeViewHolder).bindItem(partsPage)
            TYPE_MARKDOWN -> (holder as MarkdownViewHolder).bindItem(partsPage)
        }
